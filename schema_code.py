...
def signup():
    print("Please enter the username by which you want to access your account: ")
    ...
    try:
        ...
        if pssd_wr == k:
            ...
            if a == '1':
                ...
                print("Wrong input! Please enter valid information")
        else:
...
def task_information(username):
    print("Enter the no. of tasks you want to ADD: ")
    j = int(input())
    f1 = open(username, 'a')
...
def task_update(username):
    ...
    print("Enter tasks which are still not started by you: ")
...
if __name__ == '__main__':
    print("WELCOME TO JASLEEN'S TASK MANAGER")
    print("Are you new to this software? ")
    a = int(input("Type 1 if new otherwise type 0 ::"))
    if a == 1:
        signup()
    elif a == 0:
        login()
